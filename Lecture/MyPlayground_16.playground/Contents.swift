...
//조건에 맞으면 assert 함수를 지나치게 되고, 그렇지 않으면 해당 메시지를 출력한다. 출력 후 디버그 멈춤
...
someFunction(info: ["name": "jenny", "age": "16"]) //age 비정상
someFunction(info: ["name": "mike"])    // age 미기재
someFunction(info: ["name": "seoyoung", "age": 26])
